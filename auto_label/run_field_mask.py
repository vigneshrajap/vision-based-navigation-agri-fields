...
from utilities import read_robot_offset_from_file, blend_color_and_image
import os
...
if __name__ == "__main__":
    ...
    robot_offset_file = os.path.join('../Frogn_Dataset/robot_offsets/training_images_offset_20191010_L1_N.txt')
    lane_spacing = 1.4
    lane_duty_cycle = 0.5
