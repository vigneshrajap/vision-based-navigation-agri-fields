...
input_camera_model = rosparam.get_param('virtualcam/input_model')#(r"/home/marianne/catkin_ws/src/trailnet_on_thorvald/trail_net/scripts/input_cam_model_campus_2018-09-21.xml")
output_camera_model = rosparam.get_param('virtualcam/output_model')#(r"/home/marianne/catkin_ws/src/trailnet_on_thorvald/trail_net/scripts/output_cam_model.xml")
...
VirtualCam.LoadCameraModels(input_camera_model, output_camera_model)
VirtualCam.SetOutputRPY(output_RPY[0],output_RPY[1],output_RPY[2])
...
def callback(image_msg):
    ...
    image_msg = cv_br.cv2_to_imgmsg(remapped_image, encoding = "rgb8")
